...
// touchScenarios verify goal-column is preserved after tap (harnessSetCursor simulates touch).
	...
	return []Scenario{
		{
			...
			Content: "one\ntwo",
			Steps: []Step{
				{Label: "tap col 2 line1", SetCursor: intp(2)},
		...
		},
		{
			...
			Content: "one\ntwo\nthree",
			Steps: []Step{
				{Label: "tap col 2 line2", SetCursor: intp(6)},
