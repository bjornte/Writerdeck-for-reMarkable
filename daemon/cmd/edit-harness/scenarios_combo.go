...
func comboScenarios() []Scenario {
	...
	return []Scenario{
		...
		},
		{
			...
			Steps: []Step{
				{Keys: []Key{{Name: "End"}}},
				{Keys: []Key{{Name: "ArrowLeft", Shift: true, Alt: true}}, Repeat: 2},
		...
		},
		{
			...
			Content: helloWorld,
			Steps: []Step{
				{Keys: []Key{{Name: "ArrowRight", Shift: true, Alt: true}}, Repeat: 2},
				{Expect: &StateExpect{Cursor: intp(11), SelStart: intp(0), SelEnd: intp(11), SelLen: intp(11)}},
			},
		},
		{
			...
			Steps: []Step{
				...
				{Expect: &StateExpect{Cursor: intp(12), SelStart: intp(7), SelEnd: intp(12), SelLen: intp(5)}},
			},
		},
		{
