...
## What it does
> No `/dev/uinput` on this kernel (it can't load it — exports trimmed; see [../DONE.md](../DONE.md)). The daemon feeds a patched keywriter over a local socket (`/run/Writerdeck.sock`) instead.
