...
**Editing.** Block cursor hides while you type, reappears after a pause. Ctrl-K note switcher saves before switching. Up/Down on the first or last line snap to line start/end. Wider margins, paper-like Lobby theme.
