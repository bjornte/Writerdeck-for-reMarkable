...
Primary source: [keywriter](https://github.com/dps/remarkable-keywriter) by Singleton (dps). Forked as [Writerdeck-keywriter](https://github.com/bjornte/Writerdeck-keywriter) (separate repo from this one). The improved modifier key / chord handling lives there. Maybe part can be a usable element for other keywriter-derived projects.
