...
new7 = (
    ...
    '        var wasLocked = lobbyVaultLocked\n'
    '        lobbyVaultLocked = !!vaultLocked\n'
    '        if (wasLocked && !lobbyVaultLocked) vaultOnUnlocked()\n'
    '    }\n'
    '\n'
    '    function vaultOnUnlocked() {\n'
    '        if (vaultPendingAction === "encrypt") {\n'
    '            var encName = vaultPendingNote\n'
    '            vaultPendingAction = ""\n'
    '            vaultPendingNote = ""\n'
    '            if (encName && selectNoteByName(encName)) writerdeck.encryptNote(encName)\n'
    '            return\n'
    '        }\n'
    ...
    '            vaultPendingAction = ""\n'
    '            vaultPendingNote = ""\n'
    '            if (decName && selectNoteByName(decName)) writerdeck.decryptNote(decName)\n'
    '            return\n'
    '        }\n'
    ...
    '                vaultBeginUnlock("Unlock to create encrypted note")\n'
    '                return\n'
    '            }\n'
    ...
    '            vaultBeginUnlock("Unlock to encrypt note")\n'
    '            return\n'
    '        }\n'
    ...
    '            vaultBeginUnlock("Unlock to decrypt note")\n'
    '            return\n'
    '        }\n'
