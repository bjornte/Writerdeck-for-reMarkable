...
new7n_fn = (
    ...
    '        }\n'
    '        if (shift && cmd && !alt) {\n'
    '            if (key === Qt.Key_Left) { extendSelectionHorizontal(0); return }\n'
    '            if (key === Qt.Key_Right) { extendSelectionHorizontal(text.length); return }\n'
    '            if (key === Qt.Key_Up) { extendSelectionHorizontal(0); return }\n'
    '            if (key === Qt.Key_Down) { extendSelectionHorizontal(text.length); return }\n'
    '        }\n'
    '        if (shift && alt && !cmd) {\n'
    '            var ap = pos\n'
    ...
    '            else ap = -1\n'
    '            if (ap >= 0) { extendSelectionHorizontal(ap); return }\n'
    '        }\n'
