...
new7 = (
    ...
    '        if (row.encrypted && lobbyVaultLocked) { vaultBeginUnlock("Unlock to edit encrypted note"); return }\n'
    ...
    '        var row = lobbyNotesModel.get(lobbyFilesIndex)\n'
    '        if (!row || row.name === "") return\n'
    '        if (row.encrypted && lobbyVaultLocked) { vaultBeginUnlock("Unlock to read encrypted note"); return }\n'
    '        isLobby = false\n'
    '        if (mode == 1) doc = query.text\n'
    '        saveFile()\n'
    ...
    '            if (pending !== "") {\n'
    '                vaultPendingLoad = ""\n'
    '                Qt.callLater(function() { doLoad(pending) })\n'
    '            }\n'
    '            return\n'
    '        }\n'
