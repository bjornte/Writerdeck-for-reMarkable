...
new7 = (
    '    function setLobbyInfo(ip, pin, syncOn, syncRepo, noteCount, lastSync) {\n'
    '        lobbyIP = ip\n'
    '        lobbyPIN = pin\n'
    '        lobbySyncOn = !!syncOn\n'
...
lobby_rect = (
    ...
    '                anchors.fill: parent\n'
    '                contentWidth: width\n'
    '                contentHeight: lobbyCol.height\n'
    '                clip: true\n'
    '                boundsBehavior: Flickable.StopAtBounds\n'
    '                Column {\n'
    '                    id: lobbyCol\n'
    '                    width: lobby.width * 0.82\n'
    ...
    '                    }\n'
    '                    Text {\n'
    '                        text: (lobbyNoteCount === 1 ? "1 note" : lobbyNoteCount + " notes") + ". Open with Ctrl-K."\n'
    '                        color: "#555555"\n'
    '                        font.pointSize: 11\n'
    '                        font.family: "Noto Sans"\n'
    '                        width: parent.width\n'
    ...
    '                            ? (lobbyLastSync !== ""\n'
    '                                ? "Last sync was " + lobbyLastSync + ". Notes are syncing to github.com/" + lobbySyncRepo\n'
    '                                : "Notes are syncing to github.com/" + lobbySyncRepo)\n'
    '                            : ("Not configured. To set up, use your phone' + chr(39) + 's browser at http://" + lobbyIP + ":8000")\n'
    ...
    '                    }\n'
    '                    Text {\n'
    '                        text: "For USB, use an OTG cable to connect.\\n\\nFor Bluetooth, connect the keyboard to your phone. Then open in your phone' + chr(39) + 's browser at http://" + lobbyIP + ":8000. Typing is forwarded to reMarkable over Wi-Fi.\\n\\n" + (lobbyPIN !== "" ? ("PIN: " + lobbyPIN) : "PIN is not set")\n'
    '                        color: "#555555"\n'
    '                        font.pointSize: 11\n'
    '                        font.family: "Noto Sans"\n'
    '                        width: parent.width\n'
