...
new7n_fn = (
    ...
    '        var clampCol = Math.min(col, nextChars - 1)\n'
    '        return nextStart + clampCol\n'
    '    }\n'
    '\n'
    ...
    '        var clampCol = Math.min(col, prevChars - 1)\n'
    '        return prevStart + clampCol\n'
    '    }\n'
    '\n'
    ...
    '                var posBefore = query.cursorPosition\n'
    '                query.undo()\n'
    '                if (query.text.length > lenBefore && query.cursorPosition === 0)\n'
    '                    query.cursorPosition = query.text.length\n'
    '                else if (query.text.length < lenBefore && posBefore > query.text.length)\n'
    '                    query.cursorPosition = Math.min(posBefore, query.text.length)\n'
    '            }\n'
    '            cursorStrong = true\n'
    '            cursorTimer.stop()\n'
    '            event.accepted = true\n'
