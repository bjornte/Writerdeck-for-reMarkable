...
Combo-tag milestones (25 combo scenarios, `--tag combo`): 6/16 @ baseline → 9/13 @ `22ad701` → **25/25** @ `071f998` (`04-45-43`, 83-scenario suite). Wrap tag **17/17** same run. Full 94: **89/94** @ `bdccee9` (`00-37-27`). First full **102**: **85/17/0** @ `01-54-49`. First full **105**: **72/33/0** @ `10-01-42` @ `f42bfbe` (critical 26/36). Latest full **105**: **91/14/0** @ `12-41-15` @ `377a053` (**critical 36/36**; remaining: goal-col, combo ctrl/word, wrap-shift-down N=3, bs-alt mid-word, read overscroll, one selection alias).
