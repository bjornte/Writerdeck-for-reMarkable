...
| 2026-07-16T17-31-53 | 105 | 90 | 36/36 | 15 | 0 | −1 | 1951 | Phase 2C: undo props in fork (`6676614`); script asserts; undo tag 5/5; critical gate 36/36 @ `17-34-55`; edit-session PASS; report `docs/recon/test-keyboard-harness-2026-07-16T17-31-53.md` |
| 2026-07-16T17-47-29 | 105 | 93 | 36/36 | 12 | 0 | +3 | 1849 | Phase 2D: Keys dispatch + edit props in fork (`b0f17a5`); script one-liner; critical gate 36/36 @ `17-46-14`; edit-session PASS; report `docs/recon/test-keyboard-harness-2026-07-16T17-47-29.md` |
| 2026-07-16T17-59-00 | 105 | 92 | 36/36 | 13 | 0 | −1 | 1802 | Phase 3 Connections/Timers: fork `db0781e`; script asserts; critical gate 36/36 @ `17-57-45`; edit-session PASS; report `docs/recon/test-keyboard-harness-2026-07-16T17-59-00.md` |
| 2026-07-16T18-10-10 | 105 | 93 | 36/36 | 12 | 0 | +1 | 1778 | Phase 3 C++ infra: fork `f7c84e9` (socket/lobby_bridge/rotation_watcher/edit.pro); script asserts; critical gate 36/36 @ `18-08-55`; edit-session PASS; report `docs/recon/test-keyboard-harness-2026-07-16T18-10-10.md` |
| 2026-07-16T18-57-31 | 105 | 93 | 36/36 | 12 | 0 | 0 | 386 | Phase 3 Lobby/shell QML: fork `68f6e32` (main.qml + lobby/*.inc); script glue only; critical gate 36/36 @ `18-56-12`; edit-session PASS; report `docs/recon/test-keyboard-harness-2026-07-16T18-57-31.md` |

Phase 3 ownership closeout (docs/rules only, no binary): fork ownership + upstream-merge policy in [decisions.md](../decisions.md) §3; `.cursor/rules/writerdeck.mdc` restored (`alwaysApply: true`); `keywriter-fork-migration.mdc` retired. Scoreboard unchanged — last full suite still **93/12/0** @ `18-57-31` (Patch LOC **386**).

Combo-tag milestones (25 combo scenarios, `--tag combo`): 6/16 @ baseline → 9/13 @ `22ad701` → **25/25** @ `071f998` (`04-45-43`, 83-scenario suite). Wrap tag **15/15** @ Phase 2B (`17-14-44`). Undo tag **5/5** @ Phase 2C (`17-31-41`). Full 94: **89/94** @ `bdccee9` (`00-37-27`). First full **102**: **85/17/0** @ `01-54-49`. First full **105**: **72/33/0** @ `10-01-42` @ `f42bfbe` (critical 26/36). Latest full **105**: **93/12/0** @ `18-57-31` @ Phase 3 Lobby/shell (`68f6e32`) (**critical 36/36** @ `18-56-12`; Patch LOC **386**). Fork migration Phase 1–3 complete.
