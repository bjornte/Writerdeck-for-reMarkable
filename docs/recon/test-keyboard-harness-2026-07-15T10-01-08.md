...
Summary: 28 pass, 6 fail, 0 prepare fail; total 25.8s

| Name | Result | Time (s) | Recovery | Cascade | Comments |
|------|--------|----------|----------|---------|----------|
| load-cursor-at-start | pass | 3.1 | no | — | — |
| home-clears-selection | pass | 0.5 | no | — | — |
| shift-right-from-home | fail | 0.6 | no | — | step 4: cursor want 3 got 1; selEnd want 3 got 1; state={1 0 1 6 abcdef 1 0 z-test-keyboard-harness.md} |
| shift-left-from-end | pass | 0.6 | no | — | — |
| shift-right-after-home-no-stale-anchor | fail | 0.7 | no | — | step 6: cursor want 2 got 0; selEnd want 2 got 0; state={0 0 0 6 abcdef 1 0 z-test-keyboard-harness.md} |
...
| gap-collapse-selection-right | fail | 1.1 | no | — | step 3: cursor want 3 got 1; selEnd want 3 got 1; selLen want 3 got 1; state={1 0 1 6 abcdef 1 0 z-test-keyboard-harness.md} |
| gap-delete-forward | pass | 2.0 | no | — | — |
| gap-delete-with-selection | pass | 1.0 | no | — | — |
| gap-select-all | pass | 0.3 | no | — | — |
