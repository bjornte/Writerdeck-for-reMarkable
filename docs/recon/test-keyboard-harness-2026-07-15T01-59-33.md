...
Summary: 46 pass, 34 fail, 1 prepare fail; total 56.6s

| Name | Result | Time (s) | Recovery | Cascade | Comments |
|------|--------|----------|----------|---------|----------|
| load-cursor-at-start | pass | 3.6 | no | — | — |
...
| combo-shift-ctrl-right | fail | 0.7 | no | — | step 2: selStart want 0 got 11; selLen want 11 got 0; state={11 11 11 11 hello world 1 0 z-test-keyboard-harness.md} |
| combo-shift-ctrl-up | fail | 0.6 | no | — | step 3: cursor want 13 got 0; selEnd want 13 got 0; selLen want 13 got 0; state={0 0 0 13 one two three 1 0 z-test-keyboard-harness.md} |
| combo-shift-ctrl-down | fail | 0.6 | no | — | step 2: selStart want 0 got 13; selLen want 13 got 0; state={13 13 13 13 one two three 1 0 z-test-keyboard-harness.md} |
