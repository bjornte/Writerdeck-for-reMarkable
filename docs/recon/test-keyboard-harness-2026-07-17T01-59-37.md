...
Summary: 15 pass, 0 fail, 0 prepare fail; total 20.6s

| Name | Result | Time (s) | Recovery | Cascade | Comments |
|------|--------|----------|----------|---------|----------|
| wrap-down-one-visual-line | pass | 2.9 | no | — | — |
...
| wrap-combo-alt-right-word | pass | 1.4 | no | — | — |
