...
Summary: 93 pass, 12 fail, 0 prepare fail; total 179.0s
...
| ctrl-shift-left-select-line | pass | 0.8 | no | — | — |
...
| ctrl-backspace-deletes-line | pass | 2.0 | no | — | — |
| shift-left-repeat-mid-doc | pass | 3.5 | no | — | — |
| cm-line-down-basic | pass | 3.3 | no | — | — |
| cm-line-up-basic | pass | 3.7 | no | — | — |
| cm-line-down-shorter | pass | 0.6 | no | — | — |
| cm-line-up-shorter | pass | 0.6 | no | — | — |
| cm-line-down-last-line | pass | 1.0 | no | — | — |
| cm-line-down-goal-col | fail | 0.9 | no | — | step 4: cursor want 6 got 7; selStart want 6 got 7; selEnd want 6 got 7; state={7 7 7 11 tre i femte 1 0 z-test-keyboard-harness.md 0} |
| cm-select-line-down | pass | 3.3 | no | — | — |
...
| cm-select-down-up-doc-end | fail | 0.9 | no | — | step 4: selStart want 9 got 8; state={9 8 9 9 en to tre 1 0 z-test-keyboard-harness.md 0} |
...
| combo-shift-ctrl-left | pass | 1.8 | no | — | — |
...
| wrap-shift-down-last-to-eof | pass | 1.0 | no | — | — |
| wrap-mixed-newline-and-wrap | pass | 0.7 | no | — | — |
| wrap-down-goal-column | pass | 1.2 | no | — | — |
| wrap-combo-alt-left-word | pass | 1.5 | no | — | — |
...
| gap-plain-left-moves-caret | pass | 3.5 | no | — | — |
...
| hw-page-right-scrolls-edit | pass | 10.7 | no | — | — |
| hw-page-left-scrolls-edit | pass | 11.2 | no | — | — |
...
| shift-up-then-down-shrinks | pass | 3.4 | no | — | — |
