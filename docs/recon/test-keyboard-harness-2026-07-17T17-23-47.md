...
Summary: 110 pass, 0 fail, 0 prepare fail; total 203.9s

| Name | Result | Time (s) | Recovery | Cascade | Comments |
|------|--------|----------|----------|---------|----------|
| load-cursor-at-start | pass | 2.3 | no | — | — |
...
| read-overscroll-clamps | pass | 8.4 | no | — | — |
| touch-down-goal-column | pass | 1.4 | no | — | — |
