...
Summary: 104 pass, 1 fail, 0 prepare fail; total 184.6s

| Name | Result | Time (s) | Recovery | Cascade | Comments |
|------|--------|----------|----------|---------|----------|
| load-cursor-at-start | pass | 2.9 | no | — | — |
...
| up-one-logical-line | pass | 4.3 | no | — | — |
| shift-down-then-up-shrinks | pass | 3.5 | no | — | — |
...
| wrap-end-on-visual-line | pass | 1.0 | no | — | — |
| undo-redo-len | pass | 1.0 | no | — | — |
| undo-cursor-reposition | pass | 1.3 | no | — | — |
| undo-mid-line-delete | pass | 1.3 | no | — | — |
...
| hw-page-left-scrolls-edit | fail | 6.9 | no | — | step 18: contentYMin want >= 13350 got 13053; state={0 0 0 26400 Page scroll filler æøå line 0000 xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx Page scr… |
