...
Summary: 108 pass, 2 fail, 0 prepare fail; total 202.3s

| Name | Result | Time (s) | Recovery | Cascade | Comments |
|------|--------|----------|----------|---------|----------|
| load-cursor-at-start | pass | 1.5 | no | — | — |
| home-clears-selection | pass | 1.0 | no | — | — |
| shift-right-from-home | fail | 2.9 | no | — | step 19: cursor want 1289 got 1288; selEnd want 1289 got 1288; selLen want 7 got 6; state={1288 1282 1288 1551 Writerdeck harness dummy — i… |
...
| ctrl-backspace-deletes-line | pass | 2.4 | no | — | — |
...
| gap-plain-right-moves-caret | pass | 3.9 | no | — | — |
| gap-plain-left-in-paragraph | pass | 3.6 | no | — | — |
| gap-plain-right-in-paragraph | pass | 3.6 | no | — | — |
...
| gap-redo-shift-ctrl-z | pass | 1.3 | no | — | — |
| gap-undo-chain | fail | 0.7 | no | — | step 5: textLen want 6 got 5; state={5 5 5 5 abc æ 1 0 z-test-keyboard-harness.md 0} |
| gap-unicode-alt-backspace | pass | 1.3 | no | — | — |
| gap-empty-doc-backspace | pass | 1.0 | no | — | — |
| gap-alt-bs-with-selection | pass | 0.8 | no | — | — |
| gap-shift-down-mid-wrapping-paras | pass | 3.5 | no | — | — |
| gap-shift-up-mid-wrapping-paras | pass | 3.3 | no | — | — |
| gap-shift-down-across-para-break | pass | 1.1 | no | — | — |
| gap-shift-up-across-para-break | pass | 1.0 | no | — | — |
| gap-shift-down-mid-short-lines | pass | 3.4 | no | — | — |
| hw-page-right-scrolls-edit | pass | 9.7 | no | — | — |
| hw-page-left-scrolls-edit | pass | 10.5 | no | — | — |
| read-overscroll-clamps | pass | 8.0 | no | — | — |
| touch-down-goal-column | pass | 1.5 | no | — | — |
| touch-up-goal-column | pass | 0.7 | no | — | — |
| touch-down-shorter-line | pass | 0.5 | no | — | — |
| shift-left-then-right-shrinks | pass | 3.2 | no | — | — |
