...
Summary: 38 pass, 0 fail, 0 prepare fail; total 76.9s

| Name | Result | Time (s) | Recovery | Cascade | Comments |
|------|--------|----------|----------|---------|----------|
| load-cursor-at-start | pass | 1.9 | no | — | — |
| home-clears-selection | pass | 1.1 | no | — | — |
...
| cm-line-down-last-line | pass | 1.5 | no | — | — |
