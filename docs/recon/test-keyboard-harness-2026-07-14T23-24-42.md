...
Summary: 37 pass, 25 fail, 0 prepare fail; total 36.2s
...
| shift-left-from-end | pass | 0.5 | no | — | — |
...
| shift-left-repeat-mid-doc | pass | 0.9 | no | — | — |
...
| combo-shift-alt-right | fail | 0.4 | no | — | step 2: cursor want 6 got 0; selEnd want 6 got 0; selLen want 6 got 0; state={0 0 0 6 1 0 z-test-keyboard-harness.md} |
...
| combo-shift-alt-down | fail | 0.3 | no | — | step 2: cursor want 7 got 0; selEnd want 7 got 0; selLen want 7 got 0; state={0 0 0 7 1 0 z-test-keyboard-harness.md} |
...
| wrap-shift-down-one-visual | pass | 0.4 | no | — | — |
...
| undo-mid-line-delete | fail | 0.7 | no | — | step 5: cursor want 4 got 1; state={1 1 1 4 1 0 z-test-keyboard-harness.md} |
