...
Summary: 6 pass, 9 fail, 0 prepare fail; total 14.2s

| Name | Result | Time (s) | Recovery | Cascade | Comments |
|------|--------|----------|----------|---------|----------|
| wrap-down-one-visual-line | fail | 2.4 | no | — | step 3: cursor want 20 got 10; state={10 10 10 199 word word word word word word word word word word word word word word word word word wor… |
