...
Summary: 36 pass, 2 fail, 0 prepare fail; total 77.6s
...
| shift-left-repeat-mid-doc | fail | 3.5 | no | — | step 19: selStart want 1430 got 1432; selLen want 7 got 5; state={1437 1432 1437 1551 Writerdeck harness dummy — ikke i vanlig notatliste  … |
| cm-line-down-basic | pass | 3.6 | no | — | — |
| cm-line-down-last-line | pass | 1.1 | no | — | — |
| combo-alt-left | pass | 3.8 | no | — | — |
| combo-alt-right | pass | 3.4 | no | — | — |
| combo-ctrl-home | pass | 1.2 | no | — | — |
| combo-ctrl-end | pass | 1.7 | no | — | — |
...
| gap-undo-chain | fail | 0.8 | no | — | step 3: cursor want 5 got 6; textLen want 5 got 6; state={6 6 6 6 abc æø 1 0 z-test-keyboard-harness.md 0} |
