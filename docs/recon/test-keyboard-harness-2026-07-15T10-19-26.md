...
Summary: 31 pass, 3 fail, 0 prepare fail; total 25.0s
...
| gap-redo-shift-ctrl-z | fail | 0.9 | no | — | step 5: cursor want 3 got 0; textLen want 3 got 0; state={0 0 0 0  1 0 z-test-keyboard-harness.md} |
| gap-undo-chain | fail | 0.9 | no | — | step 5: cursor want 2 got 1; textLen want 2 got 1; state={1 1 1 1 a 1 0 z-test-keyboard-harness.md} |
