...
Summary: 91 pass, 14 fail, 0 prepare fail; total 174.8s
...
| shift-left-from-end | pass | 3.7 | no | — | — |
| shift-right-after-home-no-stale-anchor | pass | 3.8 | no | — | — |
| shift-left-after-end-no-stale-anchor | pass | 3.3 | no | — | — |
| shift-down-after-arrow-down | pass | 3.4 | no | — | — |
| shift-up-after-arrow-down | fail | 3.7 | no | — | step 21: selStart want 1495 got 1476; selLen want 0 got 19; state={1495 1476 1495 1551 Writerdeck harness dummy — ikke i vanlig notatliste … |
...
| cm-select-line-down | pass | 3.5 | no | — | — |
...
| combo-ctrl-down | pass | 1.3 | no | — | — |
| combo-shift-alt-left | fail | 0.7 | no | — | step 3: selStart want 1168 got 1181; selLen want 17 got 4; state={1185 1181 1185 1551 Writerdeck harness dummy — ikke i vanlig notatliste  … |
...
| combo-shift-alt-right | pass | 1.4 | no | — | — |
...
| combo-shift-ctrl-right | fail | 0.8 | no | — | step 2: cursor want 11 got 0; selEnd want 11 got 0; selLen want 11 got 0; state={0 0 0 11 hello world 1 0 z-test-keyboard-harness.md 0} |
...
| bs-alt-word-mid | fail | 1.4 | no | — | step 4: cursor want 1143 got 1142; textLen want 1548 got 1547; state={1142 1142 1142 1547 Writerdeck harness dummy — ikke i vanlig notatlis… |
...
| wrap-down-not-jump-paragraph | pass | 0.9 | no | — | — |
| wrap-up-from-visual-line-2 | pass | 1.7 | no | — | — |
| wrap-shift-down-one-visual | pass | 1.1 | no | — | — |
| wrap-shift-down-then-up-shrinks | pass | 1.2 | no | — | — |
...
| gap-plain-left-moves-caret | pass | 3.6 | no | — | — |
| gap-plain-right-moves-caret | pass | 3.4 | no | — | — |
| gap-plain-left-in-paragraph | fail | 1.6 | no | — | step 11: cursor want 178 got 177; selStart want 178 got 177; selEnd want 178 got 177; state={177 177 177 1551 Writerdeck harness dummy — ik… |
| gap-plain-right-in-paragraph | pass | 3.5 | no | — | — |
| gap-plain-left-at-doc-start | pass | 1.4 | no | — | — |
...
| gap-alt-bs-with-selection | fail | 0.8 | no | — | step 3: selStart want 1168 got 1181; selLen want 17 got 4; state={1185 1181 1185 1551 Writerdeck harness dummy — ikke i vanlig notatliste  … |
| hw-page-right-scrolls-edit | pass | 9.3 | no | — | — |
| hw-page-left-scrolls-edit | pass | 10.5 | no | — | — |
| read-overscroll-clamps | fail | 1.1 | no | — | step 3: mode want 0 got 1; state={0 0 0 5280 Page scroll filler æøå line 0000 xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx Page scroll filler æøå line … |
| touch-down-goal-column | pass | 0.6 | no | — | — |
| touch-up-goal-column | pass | 0.6 | no | — | — |
| touch-down-shorter-line | pass | 0.6 | no | — | — |
| shift-left-then-right-shrinks | pass | 3.7 | no | — | — |
| shift-right-then-left-shrinks | pass | 3.4 | no | — | — |
| shift-up-then-down-shrinks | pass | 3.2 | no | — | — |
