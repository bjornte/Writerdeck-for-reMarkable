...
Summary: 37 pass, 25 fail, 0 prepare fail; total 39.9s

| Name | Result | Time (s) | Recovery | Cascade | Comments |
|------|--------|----------|----------|---------|----------|
| load-cursor-at-start | pass | 0.5 | no | — | — |
| home-clears-selection | pass | 0.6 | no | — | — |
| shift-right-from-home | pass | 0.8 | no | — | — |
...
| shift-down-then-up-shrinks | pass | 1.0 | no | — | — |
| shift-left-repeat-from-end | pass | 0.8 | no | — | — |
| alt-backspace-deletes-word | pass | 0.6 | no | — | — |
| ctrl-backspace-deletes-line | pass | 0.7 | no | — | — |
| shift-left-repeat-mid-doc | pass | 0.7 | no | — | — |
| cm-line-down-basic | pass | 0.7 | no | — | — |
| cm-line-down-shorter | pass | 0.7 | no | — | — |
| cm-line-down-last-line | pass | 0.9 | no | — | — |
| cm-line-down-goal-col | fail | 0.7 | no | — | step 4: cursor want 11 got 6; selStart want 11 got 6; selEnd want 11 got 6; state={6 6 6 11 1 0 z-test-keyboard-harness.md} |
| cm-select-line-down | pass | 0.6 | no | — | — |
| cm-select-line-down-mid | fail | 0.8 | no | — | step 4: cursor want 7 got 4; selEnd want 7 got 4; selLen want 5 got 2; state={4 2 4 13 1 0 z-test-keyboard-harness.md} |
...
| combo-ctrl-down | fail | 0.5 | no | — | step 2: cursor want 13 got 0; selStart want 13 got 0; selEnd want 13 got 0; state={0 0 0 13 1 0 z-test-keyboard-harness.md} |
| combo-shift-alt-left | fail | 0.6 | no | — | step 3: cursor want 11 got 5; selStart want 6 got 5; selEnd want 11 got 5; selLen want 5 got 0; state={5 5 5 5 1 0 z-test-keyboard-harness.… |
...
| combo-shift-ctrl-up | fail | 0.6 | no | — | step 3: cursor want 13 got 0; selEnd want 13 got 0; selLen want 13 got 0; state={0 0 0 10 1 0 z-test-keyboard-harness.md} |
...
| undo-mid-line-delete | fail | 0.8 | no | — | step 5: cursor want 4 got 1; state={1 1 1 4 1 0 z-test-keyboard-harness.md} |
