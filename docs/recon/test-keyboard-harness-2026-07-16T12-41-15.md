...
Summary: 91 pass, 14 fail, 0 prepare fail; total 177.9s

| Name | Result | Time (s) | Recovery | Cascade | Comments |
|------|--------|----------|----------|---------|----------|
| load-cursor-at-start | pass | 3.8 | no | — | — |
...
| wrap-shift-down-one-visual | fail | 1.0 | no | — | step 5: cursor want 60 got 199; selEnd want 60 got 199; state={199 0 199 199 word word word word word word word word word word word word wo… |
| wrap-shift-down-then-up-shrinks | pass | 1.2 | no | — | — |
| wrap-down-last-visual-line | pass | 1.6 | no | — | — |
| wrap-shift-down-last-to-eof | pass | 0.9 | no | — | — |
| wrap-mixed-newline-and-wrap | pass | 0.7 | no | — | — |
| wrap-down-goal-column | pass | 0.9 | no | — | — |
| wrap-combo-alt-left-word | pass | 2.0 | no | — | — |
...
| read-overscroll-clamps | fail | 3.4 | no | — | step 3: mode want 0 got 1; state={0 0 0 5280 Page scroll filler æøå line 0000 xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx Page scroll filler æøå line … |
| touch-down-goal-column | pass | 0.7 | no | — | — |
| touch-up-goal-column | pass | 0.5 | no | — | — |
| touch-down-shorter-line | pass | 0.6 | no | — | — |
| shift-left-then-right-shrinks | fail | 1.4 | no | — | step 6: selStart want 1292 got 1293; selLen want 5 got 4; state={1297 1293 1297 1551 Writerdeck harness dummy — ikke i vanlig notatliste  F… |
| shift-right-then-left-shrinks | pass | 3.8 | no | — | — |
