...
| shift-left-repeat-mid-doc | fail | 0.4 | no | — | step 2: cursor want 12 got 3; state={3 3 3 12 1 0 z-test-keyboard-harness.md} |
...
| cm-select-up-basic | fail | 0.6 | no | — | step 3: cursor want 13 got 3; selStart want 4 got 0; selEnd want 13 got 3; selLen want 9 got 3; state={3 0 3 13 1 0 z-test-keyboard-harness… |
...
| combo-alt-right | fail | 0.6 | no | — | step 3: cursor want 6 got 0; selStart want 6 got 0; selEnd want 6 got 0; state={0 0 0 11 1 0 z-test-keyboard-harness.md} |
| combo-alt-up | pass | 0.5 | no | — | — |
| combo-alt-down | fail | 0.5 | no | — | step 3: cursor want 7 got 0; selStart want 7 got 0; selEnd want 7 got 0; state={0 0 0 12 1 0 z-test-keyboard-harness.md} |
| combo-ctrl-left | pass | 0.5 | no | — | — |
| combo-ctrl-right | fail | 0.5 | no | — | step 3: cursor want 11 got 0; selStart want 11 got 0; selEnd want 11 got 0; state={0 0 0 11 1 0 z-test-keyboard-harness.md} |
| combo-ctrl-up | pass | 0.5 | no | — | — |
| combo-ctrl-down | fail | 0.5 | no | — | step 3: cursor want 13 got 0; selStart want 13 got 0; selEnd want 13 got 0; state={0 0 0 13 1 0 z-test-keyboard-harness.md} |
...
| combo-shift-alt-right | fail | 0.5 | no | — | step 3: cursor want 6 got 0; selEnd want 6 got 0; selLen want 6 got 0; state={0 0 0 11 1 0 z-test-keyboard-harness.md} |
...
| combo-shift-alt-down | fail | 0.5 | no | — | step 3: cursor want 7 got 0; selEnd want 7 got 0; selLen want 7 got 0; state={0 0 0 12 1 0 z-test-keyboard-harness.md} |
...
| combo-shift-ctrl-right | fail | 0.5 | no | — | step 3: cursor want 11 got 0; selEnd want 11 got 0; selLen want 11 got 0; state={0 0 0 11 1 0 z-test-keyboard-harness.md} |
...
| combo-shift-ctrl-down | fail | 0.5 | no | — | step 3: cursor want 13 got 0; selEnd want 13 got 0; selLen want 13 got 0; state={0 0 0 13 1 0 z-test-keyboard-harness.md} |
| combo-shift-home-line | fail | 0.5 | no | — | step 3: cursor want 7 got 3; selEnd want 7 got 3; selLen want 7 got 3; state={3 0 3 7 1 0 z-test-keyboard-harness.md} |
| combo-shift-end-line | fail | 0.8 | no | — | step 4: cursor want 7 got 0; selStart want 4 got 0; selEnd want 7 got 0; selLen want 3 got 0; state={0 0 0 0 1 1 }; editor in lobby after f… |
| combo-ctrl-home | pass | 0.5 | no | — | — |
| combo-ctrl-end | fail | 0.5 | no | — | step 3: cursor want 7 got 0; selStart want 7 got 0; selEnd want 7 got 0; state={0 0 0 7 1 0 z-test-keyboard-harness.md} |
...
| combo-shift-ctrl-end | fail | 0.5 | no | — | step 3: cursor want 7 got 0; selStart want 4 got 0; selEnd want 7 got 0; selLen want 3 got 0; state={0 0 0 7 1 0 z-test-keyboard-harness.md} |
| bs-alt-word-mid | fail | 0.9 | no | — | step 5: textLen want 5 got 8; state={5 5 5 8 1 0 z-test-keyboard-harness.md} |
| bs-ctrl-line-start | fail | 0.7 | no | — | step 4: cursor want 6 got 0; textLen want 6 got 5; state={0 0 0 5 1 0 z-test-keyboard-harness.md} |
