...
Summary: 37 pass, 1 fail, 0 prepare fail; total 72.9s
...
| shift-left-from-end | fail | 2.9 | no | — | step 19: selStart want 1306 got 1307; selLen want 7 got 6; state={1313 1307 1313 1551 Writerdeck harness dummy — ikke i vanlig notatliste  … |
| shift-right-after-home-no-stale-anchor | pass | 3.6 | no | — | — |
