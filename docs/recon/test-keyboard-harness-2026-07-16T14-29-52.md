...
Summary: 92 pass, 13 fail, 0 prepare fail; total 163.5s
...
| shift-left-after-end-no-stale-anchor | pass | 3.2 | no | — | — |
...
| up-one-logical-line | pass | 3.2 | no | — | — |
| shift-down-then-up-shrinks | pass | 3.2 | no | — | — |
...
| cm-line-up-basic | pass | 3.2 | no | — | — |
| cm-line-down-shorter | pass | 0.6 | no | — | — |
| cm-line-up-shorter | pass | 0.6 | no | — | — |
...
| cm-select-up-basic | pass | 3.2 | no | — | — |
...
| combo-alt-up | pass | 1.0 | no | — | — |
| combo-alt-down | pass | 0.9 | no | — | — |
...
| combo-shift-alt-right | pass | 1.0 | no | — | — |
...
| combo-shift-ctrl-right | fail | 0.8 | no | — | step 4: selStart want 0 got 11; selLen want 11 got 0; state={11 11 11 11 hello world 1 0 z-test-keyboard-harness.md 0} |
...
| bs-alt-word-mid | fail | 0.7 | no | — | step 4: cursor want 1143 got 1142; textLen want 1548 got 1547; state={1142 1142 1142 1547 Writerdeck harness dummy — ikke i vanlig notatlis… |
...
| wrap-shift-down-one-visual | fail | 0.8 | no | — | step 5: cursor want 60 got 199; selEnd want 60 got 199; state={199 0 199 199 word word word word word word word word word word word word wo… |
...
| gap-plain-left-at-doc-start | pass | 0.9 | no | — | — |
...
| gap-alt-bs-with-selection | fail | 0.6 | no | — | step 3: selStart want 1168 got 1181; selLen want 17 got 4; state={1185 1181 1185 1551 Writerdeck harness dummy — ikke i vanlig notatliste  … |
| hw-page-right-scrolls-edit | pass | 8.5 | no | — | — |
| hw-page-left-scrolls-edit | pass | 9.7 | no | — | — |
| read-overscroll-clamps | fail | 0.9 | no | — | step 3: mode want 0 got 1; state={0 0 0 5280 Page scroll filler æøå line 0000 xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx Page scroll filler æøå line … |
...
| shift-right-then-left-shrinks | pass | 3.2 | no | — | — |
