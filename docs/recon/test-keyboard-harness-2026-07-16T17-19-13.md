...
Summary: 35 pass, 1 fail, 0 prepare fail; total 64.0s
...
| shift-down-after-arrow-down | fail | 1.1 | no | — | step 6: cursor want 1457 got 1438; selEnd want 1457 got 1438; selLen want 95 got 76; state={1438 1362 1438 1551 Writerdeck harness dummy — … |
| shift-up-after-arrow-down | pass | 3.2 | no | — | — |
| ctrl-shift-left-select-line | pass | 0.5 | no | — | — |
| down-one-logical-line | pass | 3.7 | no | — | — |
