...
Summary: 112 pass, 0 fail, 0 prepare fail; total 198.7s
...
| cm-select-line-down | pass | 3.8 | no | — | — |
...
| gap-copy-paste | pass | 0.9 | no | — | — |
| gap-cut-paste | pass | 1.0 | no | — | — |
