...
Summary: 104 pass, 1 fail, 0 prepare fail; total 190.0s
...
| shift-down-then-up-shrinks | pass | 3.6 | no | — | — |
...
| cm-select-up-basic | fail | 5.2 | no | — | step 21: selStart want 1495 got 1400; selLen want 0 got 95; state={1495 1400 1495 1551 Writerdeck harness dummy — ikke i vanlig notatliste … |
...
| touch-down-goal-column | pass | 3.2 | no | — | — |
