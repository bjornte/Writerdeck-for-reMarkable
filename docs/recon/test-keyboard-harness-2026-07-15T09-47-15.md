...
Summary: 68 pass, 21 fail, 1 prepare fail; total 64.4s
...
| shift-down-then-up-shrinks | fail | 1.1 | no | — | step 7: cursor want 17 got 12; selEnd want 17 got 12; selLen want 5 got 0; state={12 12 12 23 line1 line2 line3 line4 1 0 z-test-keyboard-h… |
...
| combo-shift-alt-left-repeat | fail | 0.6 | no | — | step 3: selStart want 0 got 6; selLen want 11 got 5; state={11 6 11 11 hello world 1 0 z-test-keyboard-harness.md} |
| combo-shift-alt-right | pass | 0.5 | no | — | — |
| combo-shift-alt-right-repeat | fail | 0.6 | no | — | step 2: selStart want 0 got 6; selLen want 11 got 5; state={11 6 11 11 hello world 1 0 z-test-keyboard-harness.md} |
...
| combo-shift-ctrl-down | pass | 0.7 | no | — | — |
...
| gap-up-at-doc-start | pass | 0.7 | no | — | — |
...
| touch-down-goal-column | fail | 0.4 | no | — | step 2: cursor want 2 got 0; selStart want 2 got 0; selEnd want 2 got 0; state={0 0 0 7 one two 1 0 z-test-keyboard-harness.md} |
| touch-up-goal-column | fail | 0.5 | no | — | step 2: cursor want 6 got 0; state={0 0 0 13 one two three 1 0 z-test-keyboard-harness.md} |
| touch-down-shorter-line | fail | 0.5 | no | — | step 2: cursor want 2 got 0; state={0 0 0 5 one t 1 0 z-test-keyboard-harness.md} |
| shift-left-then-right-shrinks | fail | 0.7 | no | — | step 5: cursor want 5 got 6; selEnd want 5 got 6; selLen want 2 got 3; state={6 3 6 6 abcdef 1 0 z-test-keyboard-harness.md} |
