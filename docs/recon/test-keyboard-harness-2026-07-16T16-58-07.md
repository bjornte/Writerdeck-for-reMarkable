...
Summary: 14 pass, 1 fail, 0 prepare fail; total 16.5s

| Name | Result | Time (s) | Recovery | Cascade | Comments |
|------|--------|----------|----------|---------|----------|
| wrap-down-one-visual-line | pass | 1.4 | no | — | — |
| wrap-down-not-jump-paragraph | pass | 0.8 | no | — | — |
| wrap-up-from-visual-line-2 | pass | 1.6 | no | — | — |
| wrap-shift-down-one-visual | pass | 1.2 | no | — | — |
| wrap-shift-down-then-up-shrinks | fail | 1.3 | no | — | step 8: selLenMin want >= 1 got 0; state={40 40 40 199 word word word word word word word word word word word word word word word word word… |
