...
Summary: 31 pass, 3 fail, 0 prepare fail; total 28.6s

| Name | Result | Time (s) | Recovery | Cascade | Comments |
|------|--------|----------|----------|---------|----------|
| load-cursor-at-start | pass | 5.0 | no | — | — |
...
| bs-plain | pass | 0.8 | no | — | — |
| wrap-down-one-visual-line | pass | 1.5 | no | — | — |
| wrap-up-from-visual-line-2 | pass | 2.3 | no | — | — |
| undo-redo-len | fail | 1.4 | no | — | step 6: cursor want 5 got 0; textLen want 5 got 0; state={0 0 0 0  1 0 z-test-keyboard-harness.md} |
