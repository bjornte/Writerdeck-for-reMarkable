...
Summary: 98 pass, 1 fail, 0 prepare fail; total 174.2s

| Name | Result | Time (s) | Recovery | Cascade | Comments |
|------|--------|----------|----------|---------|----------|
| load-cursor-at-start | pass | 3.0 | no | — | — |
...
| hw-page-right-scrolls-edit | pass | 10.1 | no | — | — |
| hw-page-left-scrolls-edit | pass | 10.6 | no | — | — |
| read-overscroll-clamps | fail | 7.1 | no | — | still at end: contentY want captured 30000 got 45000; not in edit mode (mode=0) after fail |
