...
Summary: 110 pass, 0 fail, 0 prepare fail; total 206.3s

| Name | Result | Time (s) | Recovery | Cascade | Comments |
|------|--------|----------|----------|---------|----------|
| load-cursor-at-start | pass | 2.5 | no | — | — |
...
| shift-left-repeat-mid-doc | pass | 4.1 | no | — | — |
...
| combo-alt-down | pass | 1.5 | no | — | — |
| combo-ctrl-left | pass | 1.7 | no | — | — |
| combo-ctrl-right | pass | 1.5 | no | — | — |
...
| combo-shift-alt-right | pass | 1.3 | no | — | — |
| combo-shift-alt-right-repeat | pass | 1.4 | no | — | — |
...
| wrap-combo-alt-right-word | pass | 1.5 | no | — | — |
...
| undo-after-select-delete | pass | 1.1 | no | — | — |
...
| gap-plain-left-at-doc-start | pass | 1.8 | no | — | — |
| gap-plain-right-at-doc-end | pass | 1.8 | no | — | — |
...
| hw-page-right-scrolls-edit | pass | 11.3 | no | — | — |
| hw-page-left-scrolls-edit | pass | 11.0 | no | — | — |
| read-overscroll-clamps | pass | 9.0 | no | — | — |
| touch-down-goal-column | pass | 1.2 | no | — | — |
