...
Summary: 110 pass, 0 fail, 0 prepare fail; total 188.8s
...
| cm-select-down-up-doc-end | pass | 0.9 | no | — | — |
...
| gap-alt-bs-with-selection | pass | 0.7 | no | — | — |
| gap-shift-down-mid-wrapping-paras | pass | 3.3 | no | — | — |
| gap-shift-up-mid-wrapping-paras | pass | 3.2 | no | — | — |
| gap-shift-down-across-para-break | pass | 1.0 | no | — | — |
| gap-shift-up-across-para-break | pass | 1.0 | no | — | — |
| gap-shift-down-mid-short-lines | pass | 3.2 | no | — | — |
| hw-page-right-scrolls-edit | pass | 9.2 | no | — | — |
| hw-page-left-scrolls-edit | pass | 9.9 | no | — | — |
| read-overscroll-clamps | pass | 7.6 | no | — | — |
| touch-down-goal-column | pass | 2.7 | no | — | — |
