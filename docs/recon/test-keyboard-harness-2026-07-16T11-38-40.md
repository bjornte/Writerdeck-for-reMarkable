...
Summary: 74 pass, 31 fail, 0 prepare fail; total 154.5s

| Name | Result | Time (s) | Recovery | Cascade | Comments |
|------|--------|----------|----------|---------|----------|
| load-cursor-at-start | pass | 3.7 | no | — | — |
| home-clears-selection | pass | 0.8 | no | — | — |
| shift-right-from-home | fail | 1.5 | no | — | step 11: cursor want 1282 got 1283; selStart want 1282 got 1281; selEnd want 1282 got 1283; selLen want 0 got 2; state={1283 1281 1283 1551… |
...
| shift-right-after-home-no-stale-anchor | fail | 1.8 | no | — | step 11: cursor want 1282 got 1283; selStart want 1282 got 1281; selEnd want 1282 got 1283; selLen want 0 got 2; state={1283 1281 1283 1551… |
| shift-left-after-end-no-stale-anchor | fail | 1.9 | no | — | step 11: cursor want 1313 got 1312; selStart want 1313 got 1312; selEnd want 1313 got 1312; state={1312 1312 1312 1551 Writerdeck harness d… |
| shift-down-after-arrow-down | fail | 2.8 | no | — | step 16: cursor want 1362 got 1343; selStart want 1324 got 1343; selEnd want 1362 got 1343; selLen want 38 got 0; state={1343 1343 1343 155… |
| shift-up-after-arrow-down | fail | 1.2 | no | — | step 6: cursor want 1495 got 1457; selStart want 1400 got 1438; selEnd want 1495 got 1457; selLen want 95 got 19; state={1457 1438 1457 155… |
| ctrl-shift-left-select-line | pass | 0.7 | no | — | — |
| down-one-logical-line | pass | 3.5 | no | — | — |
| up-one-logical-line | pass | 3.3 | no | — | — |
| shift-down-then-up-shrinks | fail | 2.4 | no | — | step 16: cursor want 1362 got 1343; selStart want 1324 got 1343; selEnd want 1362 got 1343; selLen want 38 got 0; state={1343 1343 1343 155… |
...
| alt-backspace-deletes-word | fail | 1.2 | no | — | step 6: cursor want 1155 got 1161; state={1161 1161 1161 1518 Writerdeck harness dummy — ikke i vanlig notatliste  Første avsnitt — Naïve c… |
...
| shift-left-repeat-mid-doc | fail | 1.8 | no | — | step 11: cursor want 1437 got 1436; selStart want 1437 got 1436; selEnd want 1437 got 1436; state={1436 1436 1436 1551 Writerdeck harness d… |
...
| cm-select-line-down | fail | 2.4 | no | — | step 16: cursor want 1362 got 1343; selStart want 1324 got 1343; selEnd want 1362 got 1343; selLen want 38 got 0; state={1343 1343 1343 155… |
| cm-select-up-basic | fail | 1.1 | no | — | step 6: cursor want 1495 got 1457; selStart want 1400 got 1438; selEnd want 1495 got 1457; selLen want 95 got 19; state={1457 1438 1457 155… |
...
| combo-ctrl-left | fail | 0.6 | no | — | step 3: cursor want 0 got 53; selStart want 0 got 53; selEnd want 0 got 53; state={53 53 53 1551 Writerdeck harness dummy — ikke i vanlig n… |
...
| combo-shift-ctrl-left-multiline | pass | 0.8 | no | — | — |
...
| gap-plain-left-in-paragraph | pass | 3.2 | no | — | — |
...
| hw-page-right-scrolls-edit | pass | 9.2 | no | — | — |
| hw-page-left-scrolls-edit | pass | 10.6 | no | — | — |
| read-overscroll-clamps | fail | 3.3 | no | — | step 3: mode want 0 got 1; state={0 0 0 5280 Page scroll filler æøå line 0000 xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx Page scroll filler æøå line … |
| touch-down-goal-column | pass | 0.7 | no | — | — |
| touch-up-goal-column | pass | 0.7 | no | — | — |
