...
Summary: 46 pass, 34 fail, 1 prepare fail; total 56.4s

| Name | Result | Time (s) | Recovery | Cascade | Comments |
|------|--------|----------|----------|---------|----------|
| load-cursor-at-start | pass | 3.4 | no | — | — |
...
| shift-left-repeat-from-end | pass | 0.7 | no | — | — |
...
| combo-shift-alt-left | fail | 0.5 | no | — | step 3: cursor want 11 got 6; selEnd want 11 got 6; selLen want 5 got 0; state={6 6 6 11 hello world 1 0 z-test-keyboard-harness.md} |
| combo-shift-alt-right | fail | 0.5 | no | — | step 2: selStart want 0 got 6; selLen want 6 got 0; state={6 6 6 11 hello world 1 0 z-test-keyboard-harness.md} |
| combo-shift-alt-up | fail | 0.5 | no | — | step 3: cursor want 12 got 0; selEnd want 12 got 0; selLen want 12 got 0; state={0 0 0 12 para1  para2 1 0 z-test-keyboard-harness.md} |
| combo-shift-alt-down | fail | 0.5 | no | — | step 2: selStart want 0 got 7; selLen want 7 got 0; state={7 7 7 12 para1  para2 1 0 z-test-keyboard-harness.md} |
| combo-shift-ctrl-left | fail | 0.6 | no | — | step 3: cursor want 11 got 0; selEnd want 11 got 0; selLen want 11 got 0; state={0 0 0 11 hello world 1 0 z-test-keyboard-harness.md} |
| combo-shift-ctrl-right | fail | 0.5 | no | — | step 2: selStart want 0 got 11; selLen want 11 got 0; state={11 11 11 11 hello world 1 0 z-test-keyboard-harness.md} |
| combo-shift-ctrl-up | fail | 0.5 | no | — | step 3: cursor want 13 got 0; selEnd want 13 got 0; selLen want 13 got 0; state={0 0 0 13 one two three 1 0 z-test-keyboard-harness.md} |
| combo-shift-ctrl-down | fail | 0.5 | no | — | step 2: selStart want 0 got 13; selLen want 13 got 0; state={13 13 13 13 one two three 1 0 z-test-keyboard-harness.md} |
...
| combo-shift-ctrl-end | fail | 0.7 | no | — | step 3: cursor want 7 got 0; selStart want 4 got 0; selEnd want 7 got 0; selLen want 3 got 0; state={0 0 0 3 def 1 0 z-test-keyboard-harnes… |
...
| wrap-down-not-jump-paragraph | fail | 0.6 | no | — | step 3: cursor want 10 got 20; state={20 20 20 199 word word word word word word word word word word word word word word word word word wor… |
| wrap-up-from-visual-line-2 | fail | 0.8 | no | — | after down: cursor want 10 got 20; state={20 20 20 199 word word word word word word word word word word word word word word word word word… |
| wrap-shift-down-one-visual | fail | 0.6 | no | — | step 3: cursor want 10 got 20; selEnd want 10 got 20; state={20 0 20 199 word word word word word word word word word word word word word w… |
...
| wrap-down-goal-column | fail | 0.9 | no | — | step 5: cursor want 10 got 24; state={24 24 24 177 abword word word word word word word word word word word word word word word word word w… |
...
| undo-redo-len | fail | 0.8 | no | — | step 4: cursor want 0 got 5; textLen want 0 got 5; state={5 4 5 5 abc d 1 0 z-test-keyboard-harness.md} |
| undo-cursor-reposition | fail | 0.7 | no | — | step 6: cursor want 31 got 8; state={8 8 8 31 Blahfive lines in this textedit 1 0 z-test-keyboard-harness.md} |
| undo-mid-line-delete | fail | 0.8 | no | — | step 5: textLen want 4 got 7; state={4 3 4 7 abc def 1 0 z-test-keyboard-harness.md} |
| redo-cleared-by-new-edit | fail | 0.6 | no | — | step 3: textLen want 0 got 3; state={3 2 3 3 abc 1 0 z-test-keyboard-harness.md} |
| undo-after-select-delete | fail | 0.6 | no | — | step 5: cursor want 0 got 6; textLen want 0 got 6; state={6 0 6 6 abcdef 1 0 z-test-keyboard-harness.md} |
...
| gap-delete-forward | fail | 0.7 | no | — | step 5: cursor want 2 got 3; textLen want 3 got 4; text want "abd" got "abcd"; state={3 2 3 4 abcd 1 0 z-test-keyboard-harness.md} |
...
| gap-redo-shift-ctrl-z | fail | 0.7 | no | — | step 3: cursor want 0 got 3; textLen want 0 got 3; state={3 2 3 3 abc 1 0 z-test-keyboard-harness.md} |
