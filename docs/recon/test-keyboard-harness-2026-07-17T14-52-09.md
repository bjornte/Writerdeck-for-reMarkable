...
Summary: 110 pass, 0 fail, 0 prepare fail; total 214.0s
...
| shift-left-after-end-no-stale-anchor | pass | 3.5 | no | — | — |
| shift-down-after-arrow-down | pass | 3.4 | no | — | — |
| shift-up-after-arrow-down | pass | 3.5 | no | — | — |
...
| combo-shift-alt-left | pass | 1.2 | no | — | — |
| combo-shift-alt-left-repeat | pass | 1.3 | no | — | — |
| combo-shift-alt-right | pass | 1.2 | no | — | — |
| combo-shift-alt-right-repeat | pass | 1.2 | no | — | — |
| combo-shift-alt-up | pass | 0.8 | no | — | — |
...
| combo-shift-ctrl-up | pass | 1.8 | no | — | — |
...
| wrap-combo-alt-left-word | pass | 1.6 | no | — | — |
...
| undo-cursor-reposition | pass | 1.6 | no | — | — |
| undo-mid-line-delete | pass | 1.1 | no | — | — |
...
| gap-plain-right-moves-caret | pass | 3.5 | no | — | — |
...
| gap-collapse-selection-left | pass | 1.2 | no | — | — |
...
| gap-type-replaces-selection | pass | 1.1 | no | — | — |
| gap-redo-shift-ctrl-z | pass | 0.9 | no | — | — |
| gap-undo-chain | pass | 0.8 | no | — | — |
| gap-unicode-alt-backspace | pass | 1.0 | no | — | — |
| gap-empty-doc-backspace | pass | 0.6 | no | — | — |
| gap-alt-bs-with-selection | pass | 1.0 | no | — | — |
| gap-shift-down-mid-wrapping-paras | pass | 3.6 | no | — | — |
| gap-shift-up-mid-wrapping-paras | pass | 3.5 | no | — | — |
| gap-shift-down-across-para-break | pass | 1.1 | no | — | — |
| gap-shift-up-across-para-break | pass | 1.1 | no | — | — |
| gap-shift-down-mid-short-lines | pass | 3.3 | no | — | — |
| hw-page-right-scrolls-edit | pass | 10.4 | no | — | — |
| hw-page-left-scrolls-edit | pass | 11.0 | no | — | — |
| read-overscroll-clamps | pass | 9.0 | no | — | — |
| touch-down-goal-column | pass | 1.9 | no | — | — |
| touch-up-goal-column | pass | 0.7 | no | — | — |
| touch-down-shorter-line | pass | 0.7 | no | — | — |
| shift-left-then-right-shrinks | pass | 3.4 | no | — | — |
| shift-right-then-left-shrinks | pass | 3.7 | no | — | — |
