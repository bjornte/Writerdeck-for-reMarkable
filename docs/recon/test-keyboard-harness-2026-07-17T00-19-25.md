...
Summary: 37 pass, 1 fail, 0 prepare fail; total 75.5s
...
| shift-left-repeat-mid-doc | fail | 3.3 | no | — | step 21: selStart want 1437 got 1436; selLen want 0 got 1; state={1437 1436 1437 1551 Writerdeck harness dummy — ikke i vanlig notatliste  … |
...
| gap-type-replaces-selection | pass | 1.4 | no | — | — |
| gap-redo-shift-ctrl-z | pass | 1.2 | no | — | — |
| gap-undo-chain | pass | 1.2 | no | — | — |
| gap-empty-doc-backspace | pass | 0.5 | no | — | — |
| gap-shift-down-mid-wrapping-paras | pass | 4.3 | no | — | — |
