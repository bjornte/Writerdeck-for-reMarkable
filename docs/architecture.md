...
**The product contract.** Writerdeck exists to produce durable Markdown notes. Every feature, patch, and deploy must satisfy this — not as optional hardening afterward. Why it is foundational: [decisions.md](decisions.md) § Document integrity. Audit (fixed / known open / unknown): [improvements.md](improvements.md) § Document integrity.
