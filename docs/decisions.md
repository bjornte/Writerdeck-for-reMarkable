...
3. Shrink the script further (Connections/Timers + C++ infra in fork); document fork ownership and upstream-merge policy here; restore general rules. Remaining script patches are Lobby/shell QML.
