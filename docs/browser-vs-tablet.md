...
Upload, download, copy, paste, and GitHub setup (toggle, repo, token, Save, Sync) stay browser-only. The sync engine runs on the tablet; Sync now lives on the Lobby Sync tab.
