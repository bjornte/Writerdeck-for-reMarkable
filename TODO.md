...
2. Keyboard editing — harness sign-off **110/110/0** @ `10-12-39` (critical **38/38/0**, includes mid-wrapping + cross-para Shift). [docs/editor-testing/todo.md](docs/editor-testing/todo.md).
...
5. Edit helpers QML → C++ **Phase B** — **next.** Move key-chord dispatcher (`handleMacArrow` / `handleMacBackspace` / `handleMacEditKeys`) into C++. Same handoff.
...
> Shipped: [DONE.md](DONE.md). Next: [docs/editor-migration-2-to-cpp/todo-handoff-edit-helper-cpp.md](docs/editor-migration-2-to-cpp/todo-handoff-edit-helper-cpp.md) Phase B (or owner physical Home check). Keyboard harness **110/110/0** @ `10-12-39`. Integrity: [integrity-audit.md](docs/integrity-audit.md).
