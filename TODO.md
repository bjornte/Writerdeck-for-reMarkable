...
2. Keyboard editing — Mac-style modifiers on device, including wrapped paragraphs (not just `\n` lines), Shift+Alt/Ctrl+arrows, undo/redo. Handoff: [docs/editor-testing/todo.md](docs/editor-testing/todo.md).
