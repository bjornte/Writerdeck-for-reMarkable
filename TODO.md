...
2. Keyboard editing — harness done (**105** scenarios). Latest **91/14** (**critical 36/36**) @ `12-41-15` @ `377a053`. Next: clear 14 non-critical → full **105/105** — [docs/editor-testing/todo.md](docs/editor-testing/todo.md).
...
> Shipped: [DONE.md](DONE.md). Next unchecked: Physical Home; keyboard editing full **105/105** (critical **36/36** @ `377a053`, 14 non-critical left — [editor-testing/todo.md](docs/editor-testing/todo.md)); keywriter fork migration. Integrity: [integrity-audit.md](docs/integrity-audit.md). After QML deploy: `test-edit-session.sh` then `test-keyboard-harness.sh --fast` (§22). Do not run edit-session and harness in parallel.
