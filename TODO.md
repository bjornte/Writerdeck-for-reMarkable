...
2. Keyboard editing — 83-scenario device harness; kernel fixes for combo/wrap/undo (best full run **38/44**, deployed head `22ad701`). Handoff: [docs/editor-testing/todo.md](docs/editor-testing/todo.md).
...
> Shipped: [DONE.md](DONE.md). Next unchecked: Physical Home; keyboard editing — **38/44 best full 83**, combo **9/13** @ `22ad701` ([editor-testing/todo.md](docs/editor-testing/todo.md), [milestone-runs.md](docs/editor-testing/milestone-runs.md)). Integrity: [integrity-audit.md](docs/integrity-audit.md). After QML edits: `test-edit-session.sh` (§21); after arrow/selection QML: `test-keyboard-harness.sh --fast` (§22, 83/83 sign-off).
